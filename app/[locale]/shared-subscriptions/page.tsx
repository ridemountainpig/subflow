...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return getFeaturePageMetadata(locale, "shared-subscriptions");
}

export default function SharedSubscriptionsPage() {
    return <RenderFeaturePage slug="shared-subscriptions" />;
}

...
export const Card = forwardRef<HTMLDivElement, CardProps>(
    ({ customClass, ...rest }, ref) => (
        <div
            ref={ref}
            {...rest}
            className={`text-subflow-50 font-poetsen border-subflow-50 bg-subflow-900 absolute top-1/3 left-1/2 overflow-hidden rounded-xl border-4 [will-change:transform] [backface-visibility:hidden] [transform-style:preserve-3d] ${customClass ?? ""} ${rest.className ?? ""}`.trim()}
        />
    ),
);
